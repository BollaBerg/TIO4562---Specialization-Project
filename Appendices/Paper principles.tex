...
\begin{longtable}{P{0.18\linewidth}P{0.1\linewidth}P{0.1\linewidth}P{0.12\linewidth}P{0.08\linewidth}P{0.1\linewidth}P{0.1\linewidth}P{0.1\linewidth}}
    ...
    \bottomrule
    \multicolumn{8}{r}{\tiny \textit{Continued on next page\ldots}}
    \endfoot
    ...
    % \midrule
    %     \textit{Papers including principle} & 32 & 21 & 28 & 6 & 7 & 20 & 7 \\ 
    %     \textit{Percentage of papers with principles} & 67\% & 44\% & 58\% & 13\% & 15\% & 42\% & 15\% \\ 
    %     \textit{Percentage of all papers} & 59\% & 39\% & 52\% & 11\% & 13\% & 37\% & 13\% \\  
    \midrule
