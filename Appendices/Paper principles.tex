...
\begin{longtable}{P{0.2\linewidth}P{0.2\linewidth}P{0.13\linewidth}P{0.13\linewidth}P{0.13\linewidth}P{0.13\linewidth}}
    ...
    % \midrule
    %     \multicolumn{2}{l}{\textit{Papers including principle}} & 23 & 26 & 31 & 38 \\ 
    %     \multicolumn{2}{l}{\textit{Percentage of papers with principles}} & 49\% & 55\% & 66\% & 81\% \\ 
    %     \multicolumn{2}{l}{\textit{Percentage of all papers}} & 43\% & 49\% & 58\% & 72\% \\  
    \midrule
        \multicolumn{2}{l}{\textit{Papers including principle}} & \textit{23} & \textit{26} & \textit{31} & \textit{38} \\ 
        \multicolumn{2}{l}{\textit{Percentage of papers with principles}} & \textit{49\%} & \textit{55\%} & \textit{66\%} & \textit{81\%} \\ 
        \multicolumn{2}{l}{\textit{Percentage of all papers}} & \textit{43\%} & \textit{49\%} & \textit{58\%} & \textit{72\%} \\  
\end{longtable}
...
\begin{longtable}{P{0.18\linewidth}P{0.1\linewidth}P{0.1\linewidth}P{0.1\linewidth}P{0.1\linewidth}P{0.1\linewidth}P{0.1\linewidth}P{0.1\linewidth}}
    ...
    %     \textit{Percentage of papers with principles} & 66\% & 81\% & 81\% & 68\% & 68\% & 45\% & 45\% \\ 
    %     \textit{Percentage of all papers} & 60\% & 40\% & 53\% & 11\% & 13\% & 38\% & 13\% \\  
    \midrule
