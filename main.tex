...
\todo[inline]{Check page numbers for Jobin, as I use a preprint that may not be the same as the actual print (which is unavailable at NTNU)}
\todo[inline]{Check that subcategories is one word throughout the text (not sub-category)}
